...
from products.taili.blind_locomotion.diagnose_taili import (
...
from products.taili.blind_locomotion.diagnose_taili_cases import RECORD_SCHEMA_VERSION as MERGED_SCHEMA_VERSION
