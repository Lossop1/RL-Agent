...
BLIND_ENV = ROOT / "autotuner" / "blind_locomotion" / "blind_tp_env.py"
CORE_REWARD = ROOT / "autotuner" / "taili_core" / "taili_reward.py"
TELEMETRY_PAYLOADS = ROOT / "autotuner" / "blind_locomotion" / "telemetry_payloads.py"
