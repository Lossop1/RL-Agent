...
from autotuner.blind_locomotion.runtime_manifest import (
...
def test_runtime_import_proof_captures_resolved_file(tmp_path: Path):
    proof = capture_runtime_execution(
        ...
        ("autotuner.blind_locomotion.runtime_manifest",),
    )
...
def test_manifest_updates_preserve_nested_launch_facts(tmp_path: Path):
    ...
    from autotuner.blind_locomotion.runtime_manifest import update_manifest
