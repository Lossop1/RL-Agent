...
class TrainingTelemetryEmitter:
    ...
    def _print_human(self, payload: dict[str, Any]) -> None:
        ...
        self._emit_line("[TPCURR] " + _kv([
            ...
            ("terr_up_rate", curr.get("terrain_move_up_rate")),
            ("terr_down_rate", curr.get("terrain_move_down_rate")),
            ("terr_fail_rate", curr.get("terrain_failure_down_rate")),
            ("terr_stable_rate", curr.get("terrain_stable_end_rate")),
            ("terr_speed_ok", curr.get("terrain_speed_ok_rate")),
            ("flat_mean", curr.get("terrain_flat_mean")),
            ("rough_mean", curr.get("terrain_rough_mean")),
            ("boxes_mean", curr.get("terrain_boxes_mean")),
            ("stairs_mean", curr.get("terrain_stairs_mean")),
            ("stairs_up_mean", curr.get("terrain_stairs_up_mean")),
            ("slope_mean", curr.get("terrain_slope_mean")),
            ("slope_inv_mean", curr.get("terrain_slope_inv_mean")),
