...
_ALLOWLIST_FILES: tuple[str, ...] = (
    ...
    "products/taili/blind_locomotion/telemetry_emit.py",
    ...
    "products/taili/blind_locomotion/reward_tuning_advisor.py",
    ...
    "products/taili/blind_locomotion/parametric_ref.py",
    "products/taili/blind_locomotion/assets/taili.py",
    "products/taili/core/taili_geometry.py",
    "products/taili/core/taili_reward.py",
    "products/taili/core/taili_curriculum.py",
    "products/taili/core/taili_obs.py",
    "products/taili/core/taili_models.py",
    "products/taili/core/taili_amp_reference.py",
