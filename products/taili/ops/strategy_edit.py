...
_STRATEGY_YAML = _REPO / "products" / "taili" / "blind_locomotion" / "taili_blind_config.yaml"
_ROLLBACK_STACK = _REPO / "products" / "taili" / "blind_locomotion" / ".strategy_rollback.jsonl"
