...
from autotuner.locomotion_console.telemetry import _actual_phase_gate_from_config, _as_float, _num
...
def metadata() -> dict[str, Any]:
    """返回控制台兼容层需要的静态记分牌元数据。"""
    return {"family_order": list(FAMILY_ORDER), "tensions": list(TENSIONS)}
